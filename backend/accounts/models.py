...
class UserAccount(AbstractBaseUser, PermissionsMixin, models.Model):
    ...
    favorite_games = models.ManyToManyField(Game, symmetrical=False, related_name='favorited_by')
    blocked_games  = models.ManyToManyField(Game, symmetrical=False, related_name='blocked_by')
