        ...
        UserApi.signup(data)
            .then(res => {
                Swal.fire({
                    ...
                    text: `Verifica tu cuenta con el correo que te enviamos`,
                        ...
                        <form noValidate onSubmit={handleSubmit} className='w-10/12'>
                            ...
                            <div className="relative w-full mb-3">
                                <label
                                    ...
                                    htmlFor="grid-password"
                                >
                                    Correo <span className='text-red-600'>*</span> <span className='text-xs'>(Te llegará un mensaje de verificación)</span>
                                </label>
                                <input
                                    id="email"
                                    className="text-white border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-input_color rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                            ...
                            <div className="text-center mt-6">
                                {!isRegistering ? (
                                    ...
                                    <button
                                        className="bg-button-color-pr-hov text-white text-sm font-bold uppercase px-6 py-3 rounded shadow-lg outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150"
                                        disabled={true}
                                    >
                                        Registrándote...
                                    </button>
