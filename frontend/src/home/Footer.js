  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-12 gap-x-5 w-full px-16 text-white font-roboto ">
        ...
        <p className="col-start-8 col-end-10">
          <a href="" target="_blank">Política de privacidad</a>
        </p>
        <p className="col-start-10 col-span-3">
        <a href="https://github.com/huparelaa/FireFly/tree/develop#readme" target="_blank">Términos y condiciones</a>
        </p>
      </div>
    </div>
  )
